...
(function () {
  ...
  if (debug === true) {
    var _FormData = function _FormData() {
      var myself = this; // Force a Constructor

      if (!(this instanceof _FormData)) return new _FormData(); //得到参数的类型？
    ...
    (this == undefined ? self : this)['FormData'] = _FormData;
    ...
    _FormData.prototype['append'] = function (name, value, filename) {
