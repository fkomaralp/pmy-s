...
<div class="w-full mx-auto py-6 sm:px-6 lg:px-8" x-data="{ confirmModal: false, deleting: false }">
    ...
    <div class="flex mb-6 flex-row space-x-8 bg-white rounded-md py-5 px-5">
        <a href="{{route("dashboard.priceses.create")}}"
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                    <div class="inline-flex rounded-md shadow-sm" role="group">
                        <a href="{{route("dashboard.priceses.edit", ["price_id" => $price->id])}}"
                           class="py-2 px-4 text-sm font-medium text-pgreen-700 rounded-l-lg border border-gray-200 hover:bg-gray-100 hover:text-pgreen-800 hover:bg-gray-100 focus:ring-4 focus:ring-gray-300">
                            {{__("Edit")}}
                        </a>
                        <button type="button" wire:click="deleteId({{$price->id}})" @click="confirmModal=true"
