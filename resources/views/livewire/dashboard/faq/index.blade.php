...
<div class="w-full mx-auto py-6 sm:px-6 lg:px-8" x-data="{ confirmModal: false, deleting: false }">
    <div class="flex mb-6 flex-row space-x-8 bg-white rounded-md py-5 px-5">
        <a href="{{route("dashboard.pages.faq.create")}}"
           class="px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-pgreen-800 hover:bg-pgreen-900">
            Create Title</a>
    </div>
    @if($faqs->count() > 0)
        <table class="w-full">
            ...
            <tr>
                ...
                <th scope="col"
                    class="py-3 px-6 text-xs font-semibold font-medium tracking-wider text-center text-gray-700 uppercase dark:text-gray-400">
                    Questions
                </th>
                <th scope="col"
                    class="py-3 px-6 text-xs font-semibold font-medium tracking-wider text-center text-gray-700 uppercase dark:text-gray-400">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="py-4 px-6 text-sm text-center font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <div class="rounded-md shadow-sm" role="group">
                            <a href="{{route("dashboard.pages.faq.question.index", ["faq_id" => $faq->id])}}"
                               class="py-2 px-4 text-sm font-medium text-positive-600 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-positive-600 hover:bg-gray-100 focus:ring-4 focus:ring-gray-300">
                                {{__("Questions")}}
                            </a>
                        </div>
                    </td>
                    <td class="py-4 px-6 text-sm text-right text-gray-500 whitespace-nowrap dark:text-gray-400">
                        <div class="inline-flex rounded-md shadow-sm" role="group">
                            <a href="{{route("dashboard.pages.faq.edit", ["faq_id" => $faq->id])}}"
                            ...
                            <button type="button" wire:click="deleteId({{$faq->id}})" @click="confirmModal=true"
        ...
        <div class="rounded bg-white w-2/7 object-none object-center -mt-11 border border-gray-400"
            ...
            <div class="relative px-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="p-6 pt-0 text-center">
                    <svg class="mx-auto mb-4 w-14 h-14 text-red-700 dark:text-red-700" fill="none"
        ...
        @else
        <div class="max-w-xl mx-auto py-10 sm:px-6 lg:px-8 text-center">
