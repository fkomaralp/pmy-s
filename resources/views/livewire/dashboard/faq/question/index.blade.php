...
<div class="w-full mx-auto py-10 sm:px-6 lg:px-8" x-data="{ confirmModal: false, deleting: false }">
    <div class="w-full h-16 block">
        <a href="{{route("dashboard.pages.faq.question.create", ["faq_id" => $faq->id])}}"
           class="px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-pgreen-800 hover:bg-pgreen-900">
            Create Question for {{$faq->title}}</a>
    </div>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="py-4 px-6 text-sm text-center text-gray-500 whitespace-nowrap dark:text-gray-400">
                        <div class="inline-flex rounded-md shadow-sm" role="group">
                            <a href="{{route("dashboard.pages.faq.question.edit", ["question_id" => $question->id])}}"
                            ...
                            <button type="button" wire:click="deleteId({{$question->id}})" @click="confirmModal=true"
