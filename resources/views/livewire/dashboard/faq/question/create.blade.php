<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ __('Create Question for ' . $faq->title) }}
    </h2>
</x-slot>
    ...
    <form wire:submit.prevent="createQuestion" >
        <div class="px-4 py-5 bg-white sm:p-6 shadow">
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input id="question" type="text" class="mt-2 block w-full" wire:model.defer="state.question"
                             autofocus/>
                <x-jet-input-error for="question" class="mt-2"/>
            </div>
            <div class="col-span-6 sm:col-span-4 mt-2">
                <x-jet-label for="answer" value="{{ __('Answer') }}"/>
                <x-jet-input id="answer" type="text" class="mt-2 block w-full" wire:model.defer="state.answer"
                             autofocus/>
