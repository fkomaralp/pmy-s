...
<div>
        ...
        function component() {
            return {
                ...
                downloadSampleHorizontal: () => {
                    ...
                    @this.downloadSampleHorizontal()
                },
                downloadSampleVertical: () => {
                    window.$wireui.notify({
                        title: 'Please wait...',
                        description: 'Downloading...',
                        icon: 'info'
    ...
    <div class="w-3/4 mx-auto py-10 sm:px-6 lg:px-8" x-data="component()">
        <form wire:submit.prevent="updateEvent" class="w-full">
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
                ...
                <div class="col-span-6 sm:col-span-4 mt-5">
                    ...
                    <div class="col-span-6 sm:col-span-4 mt-3">
                        ...
                        >
                            <div class="relative">
                                <input id="status" type="checkbox" class="sr-only" wire:model="status"/>
                ...
                <div class="col-span-6 sm:col-span-4 mt-5">
                    ...
                    <div class="col-span-6 sm:col-span-4 mt-3">
                        ...
                        >
                            <div class="relative">
                                <input id="protected" type="checkbox" class="sr-only" wire:model="protected"/>
                                <div class="w-10 h-4 bg-gray-400 rounded-full shadow-inner"></div>
                                <div
                                    class="dot absolute w-6 h-6 bg-white rounded-full shadow -left-1 -top-1 transition"></div>
                            </div>
                    ...
                    <div class="flex flex-row">
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="col-span-6 sm:col-span-4 mt-5">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                                           for="image">{{ __('Sponsors frame for Horizontal image') }}</label>
                        ...
                        <div class="flex-1 w-80">
                            <div class="flex-1 w-full bg-white">
                                <div class="flex flex-row">
                                    <button type="button" class="flex-1 px-3 py-3" @click="showTab(0)" :class="{'bg-pgreen-800 text-white' : tab === 0}">Vertical</button>
                                    <button type="button" class="flex-1 px-3 py-3" @click="showTab(1)" :class="{'bg-pgreen-800 text-white' : tab === 1}">Horizontal</button>
                                </div>
                                <div class="flex-1 w-full p-5" x-show="tab === 0">
                                    <div class="text-red-500 w-full text-center text-sm mb-3">
                                        <img src="{{$this->event->sponsor_vertical_image}}">
                                    </div>
                                    <button type="button" @click="downloadSampleHorizontal" class="w-full px-4 py-2 bg-gray-700 hover:bg-gray-900 border border-transparent font-semibold text-xs text-white uppercase tracking-widest active:bg-pgreen-900 focus:outline-none focus:border-pgreen-800 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">Download sample</button>
                                </div>
                                <div class="flex-1 w-full p-5" x-show="tab === 1">
                                    <div class="text-red-500 w-full text-center text-sm mb-3">
                                        <img src="{{$this->event->sponsor_horizontal_image}}">
                                    </div>
                                    <button type="button" @click="downloadSampleVertical" class="w-full px-4 py-2 bg-gray-700 hover:bg-gray-900 border border-transparent font-semibold text-xs text-white uppercase tracking-widest active:bg-pgreen-900 focus:outline-none focus:border-pgreen-800 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">Download sample</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-span-6 sm:col-span-4 mt-5">
                    ...
                    <x-jet-input id="note" type="text" class="mt-1 block w-full" wire:model.defer="state.note"
                                 autofocus/>
                ...
                <div class="col-span-6 sm:col-span-4 mt-5">
                    <div class="flex flex-row justify-between">
                        <div class="basis-1/2 my-auto">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                                   for="user_avatar">{{ __('Image') }}</label>
                            ...
                            @if($event->image !== null)
                                <div class="">
                                    <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="user_avatar_help"><img class="rounded border-gray-300" src="{{$event->image}}" width="200"></div>
                                </div>
                                @else
                                <div class="my-auto">
                                    <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="user_avatar_help">No photos uploaded.</div>
                                </div>
                            @endif
                    </div>
                </div>
...
{{--                <div class="col-span-6 sm:col-span-4 mt-5">--}}
{{--                    <x-jet-label for="title" value="{{ __('Event Date') }}"/>--}}
{{--                    <div class="mt-1">--}}
{{--                        @include('components.date-time-picker', ["modelName" => "event_date", "value" => $event_date])--}}
{{--                    </div>--}}
